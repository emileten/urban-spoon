...
def map_bidecadal_time_average(inputfile, var, color_bar_range, outputfile, format="png"):
    ...
    core.plot_colored_maps(da=da_dict, common_title=f"{var} bidecadal average", units=da.attrs["units"], color_bar_range=color_bar_range)
